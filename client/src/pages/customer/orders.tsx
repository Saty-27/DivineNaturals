  ...
  const mockOrders = [
    {
      ...
      totalAmount: "180",
      items: [
        { name: "Toned Milk", quantity: 2, unit: "500ml", price: 30 },
        { name: "Fresh Paneer", quantity: 1, unit: "200g", price: 80 },
        { name: "Pure Ghee", quantity: 1, unit: "100ml", price: 70 }
      ],
      deliveryPartner: {
        name: "Amit Kumar",
    ...
    },
    {
      ...
      totalAmount: "120",
      items: [
        { name: "Fresh Milk", quantity: 2, unit: "500ml", price: 60 }
      ],
      deliveryPartner: {
        name: "Suresh Patil",
      ...
      deliveredAt: "2025-08-22T19:15:00Z",
      rating: 5,
      feedback: "Excellent service! Fresh milk as always."
    }
  ];

  const allOrders = Array.isArray(orders) ? orders : mockOrders;
