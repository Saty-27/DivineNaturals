...
export default function VendorsPage() {
  const stats = [
    { title: "Total Vendors", value: "124", icon: Store, color: "text-blue-600", bgColor: "bg-blue-50" },
    { title: "Active Vendors", value: "98", icon: Users, color: "text-green-600", bgColor: "bg-green-50" },
    { title: "Total Revenue", value: "₹2.4L", icon: DollarSign, color: "text-orange-600", bgColor: "bg-orange-50" },
