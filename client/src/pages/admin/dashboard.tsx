          ...
          <Card className="eco-card">
            <CardHeader>
              <CardTitle className="text-[hsl(var(--eco-secondary))] flex items-center text-xl font-black">
                ...
                📋 Daily Requirements & Circulation
              </CardTitle>
            </CardHeader>
            <CardContent>
              <div className="grid lg:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <h3 className="text-lg font-bold text-[hsl(var(--eco-secondary))]">Today's Requirements</h3>
                  <div className="space-y-3">
                    <div className="p-4 border rounded-lg bg-blue-50">
                      <div className="flex justify-between items-center">
                        <div>
                          <p className="font-bold text-blue-800">Santacruz Zone</p>
                          <p className="text-sm text-blue-600">4 vendors, 16 sub-vendors</p>
                        </div>
                        <div className="text-right">
                          <div className="text-xl font-black text-blue-700">2,500L</div>
                    ...
                    <div className="p-4 border rounded-lg bg-green-50">
                      <div className="flex justify-between items-center">
                        <div>
                          <p className="font-bold text-green-800">Andheri Zone</p>
                          <p className="text-sm text-green-600">4 vendors, 16 sub-vendors</p>
                        </div>
                        <div className="text-right">
                          <div className="text-xl font-black text-green-700">2,200L</div>
                ...
                <div className="space-y-4">
                  <h3 className="text-lg font-bold text-[hsl(var(--eco-secondary))]">Circulation Status</h3>
                  <div className="space-y-3">
                    <div className="p-4 border rounded-lg bg-green-50">
                      <div className="flex justify-between items-center">
                        <div>
                          <p className="font-bold text-green-800">Delivered</p>
                          <p className="text-sm text-green-600">Successfully distributed</p>
                        </div>
                        <div className="text-right">
                          <div className="text-xl font-black text-green-700">4,200L</div>
                          <div className="text-sm text-green-600">89% of target</div>
                        </div>
                      </div>
                    </div>
                    <div className="p-4 border rounded-lg bg-orange-50">
                      <div className="flex justify-between items-center">
                        <div>
                          <p className="font-bold text-orange-800">Pending</p>
                          <p className="text-sm text-orange-600">Needs immediate attention</p>
                        </div>
                        <div className="text-right">
                          <div className="text-xl font-black text-orange-700">500L</div>
                          <div className="text-sm text-orange-600">11% shortfall</div>
                        </div>
                      </div>
                    </div>
                  </div>
...
function InventoryManagementContent({ onAction }: any) {
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-bold text-[hsl(var(--eco-secondary))]">📦 Inventory Management</h2>
          <p className="text-[hsl(var(--eco-text-muted))] font-semibold">Stock tracking and expiry management</p>
        </div>
        <div className="flex gap-2">
          <Button className="eco-button" onClick={() => onAction("Update Stock")}>
            <Package className="w-4 h-4 mr-2" />
            Update Stock
          </Button>
          <Button className="eco-button-secondary">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
        <StatsCard title="Milk Stock" value="2,500L" icon={<Milk className="w-6 h-6" />} trend="Current levels" color="text-blue-600" bgColor="bg-blue-50" />
        <StatsCard title="Bottles" value="1,200" icon={<Package className="w-6 h-6" />} trend="Available units" color="text-green-600" bgColor="bg-green-50" />
        <StatsCard title="Crates" value="340" icon={<Package className="w-6 h-6" />} trend="In circulation" color="text-purple-600" bgColor="bg-purple-50" />
        <StatsCard title="Low Stock Alerts" value="5" icon={<AlertTriangle className="w-6 h-6" />} trend="Needs ordering" color="text-orange-600" bgColor="bg-orange-50" />
        <StatsCard title="Expiry Alerts" value="2" icon={<Clock className="w-6 h-6" />} trend="Items expiring" color="text-red-600" bgColor="bg-red-50" />
      </div>
      ...
      <Card className="eco-card">
        ...
        <CardContent>
          <div className="text-center py-12">
            ...
            <p className="text-lg font-semibold text-gray-500 mb-4">Inventory Management Platform</p>
            <p className="text-gray-400 mb-6">Stock levels, expiry tracking, wastage reports, and automated ordering</p>
            <Button className="eco-button">Build Inventory Dashboard</Button>
          </div>
        </CardContent>
      </Card>
    </div>
